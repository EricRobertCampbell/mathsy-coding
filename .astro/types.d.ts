...
"2024-01-01-sampling-distributions/index.md": {
  id: "2024-01-01-sampling-distributions/index.md",
  slug: "2024-01-01-sampling-distributions",
  body: string,
  collection: "blog",
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] },
"2024-02-05-ci-means-small-n/index.md": {
  id: "2024-02-05-ci-means-small-n/index.md",
  slug: "2024-02-05-ci-means-small-n",
  body: string,
  collection: "blog",
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] },
